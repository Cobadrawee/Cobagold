      ...
      {shouldTruncate && (
        <div className="relative mt-6 flex justify-center">
          <button
            type="button"
            onClick={onToggle}
            className="inline-flex items-center justify-center rounded-full border border-[#146B54] bg-[#0B513F] px-4 py-2 text-xs font-medium text-[#09CF91] transition-colors hover:bg-[#0F614B]"
          >
